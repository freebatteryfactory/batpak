...
/// remain runtime evidence and are not catalog fields.
///
...
pub const PLAN_COMPILE_REFUSAL: &[VerificationRequirement] = &[VerificationRequirement { method: VerificationMethod::CompileRefusal, basis: VerificationBasis::DirectBoundary { route: None }, coverage: VerificationCoverage::Sampled, lane: VerificationLane::PullRequestFast, enforcement: VerificationEnforcementPosture::Blocking }];
pub const PLAN_PROPERTY: &[VerificationRequirement] = &[VerificationRequirement { method: VerificationMethod::PropertySequence, basis: VerificationBasis::DirectBoundary { route: None }, coverage: VerificationCoverage::Sampled, lane: VerificationLane::Merge, enforcement: VerificationEnforcementPosture::Blocking }];
pub const PLAN_COMPLEXITY: &[VerificationRequirement] = &[VerificationRequirement { method: VerificationMethod::ComplexityContract, basis: VerificationBasis::DirectBoundary { route: None }, coverage: VerificationCoverage::Sampled, lane: VerificationLane::Merge, enforcement: VerificationEnforcementPosture::Blocking }];
...
pub const PLAN_RECONCILIATION_REFINEMENT: &[VerificationRequirement] = &[
    ...
    VerificationRequirement { method: VerificationMethod::DifferentialExecution, basis: VerificationBasis::IndependentReference { route: IndependentEvidenceRouteKind::DifferentialImplementation }, coverage: VerificationCoverage::Bounded, lane: VerificationLane::Merge, enforcement: VerificationEnforcementPosture::Blocking },
    VerificationRequirement { method: VerificationMethod::ScheduleExploration, basis: VerificationBasis::DirectBoundary { route: Some(IndependentEvidenceRouteKind::HostileBoundary) }, coverage: VerificationCoverage::Bounded, lane: VerificationLane::Scheduled, enforcement: VerificationEnforcementPosture::Blocking },
];
pub const PLAN_LAW_CHANGE_REFUSAL: &[VerificationRequirement] = &[
    VerificationRequirement { method: VerificationMethod::TranslationValidation, basis: VerificationBasis::IndependentReference { route: IndependentEvidenceRouteKind::DifferentialImplementation }, coverage: VerificationCoverage::Bounded, lane: VerificationLane::Merge, enforcement: VerificationEnforcementPosture::Blocking },
    VerificationRequirement { method: VerificationMethod::PropertySequence, basis: VerificationBasis::DirectBoundary { route: Some(IndependentEvidenceRouteKind::HostileBoundary) }, coverage: VerificationCoverage::Sampled, lane: VerificationLane::Merge, enforcement: VerificationEnforcementPosture::Blocking },
];
pub const PLAN_FRONTIER_EXPLORATION: &[VerificationRequirement] = &[VerificationRequirement { method: VerificationMethod::BoundedStateExploration, basis: VerificationBasis::DirectBoundary { route: Some(IndependentEvidenceRouteKind::HostileBoundary) }, coverage: VerificationCoverage::Bounded, lane: VerificationLane::Scheduled, enforcement: VerificationEnforcementPosture::Blocking }];
...
pub const PROOF_ROWS: &[ProofRowRecord] = &[
    ...
    ProofRowRecord { id: ProofRowId("driver_await_and_cooperative_drive_produce_equivalent_logical_trace"), state: ProofRowState::Active { guarantee: GuaranteeRef::dec("DEC-075"), projection_contracts: &[ContractId("BP-SYSTEM-MODEL-1")], claim: VerificationClaimKind::Refinement, verification: PLAN_RECONCILIATION_REFINEMENT } },
    ...
    ProofRowRecord { id: ProofRowId("browser_and_native_profiles_preserve_program_semantics"), state: ProofRowState::Active { guarantee: GuaranteeRef::dec("DEC-065"), projection_contracts: &[ContractId("BP-REPOSITORY-PACKAGES-1")], claim: VerificationClaimKind::Refinement, verification: PLAN_DIFFERENTIAL } },
    ...
    ProofRowRecord { id: ProofRowId("candidate_origin_confers_no_authority"), state: ProofRowState::Active { guarantee: GuaranteeRef::dec("DEC-079"), projection_contracts: &[ContractId("BP-SPROUTING-1")], claim: VerificationClaimKind::Safety, verification: PLAN_HOSTILE_BOUNDARY } },
    ProofRowRecord { id: ProofRowId("scaffold_cannot_close_realization"), state: ProofRowState::Active { guarantee: GuaranteeRef::dec("DEC-079"), projection_contracts: &[ContractId("BP-SPROUTING-1")], claim: VerificationClaimKind::Safety, verification: PLAN_STRUCTURAL } },
    ProofRowRecord { id: ProofRowId("qualified_nursery_record_is_not_promoted_source"), state: ProofRowState::Active { guarantee: GuaranteeRef::dec("DEC-079"), projection_contracts: &[ContractId("BP-SPROUTING-1")], claim: VerificationClaimKind::Safety, verification: PLAN_HOSTILE_BOUNDARY } },
    ProofRowRecord { id: ProofRowId("law_changing_candidate_cannot_enter_realization_preserving_lane"), state: ProofRowState::Active { guarantee: GuaranteeRef::dec("DEC-080"), projection_contracts: &[ContractId("BP-SPROUTING-1")], claim: VerificationClaimKind::Safety, verification: PLAN_LAW_CHANGE_REFUSAL } },
    ProofRowRecord { id: ProofRowId("search_budget_is_declared_and_receipted"), state: ProofRowState::Active { guarantee: GuaranteeRef::dec("DEC-081"), projection_contracts: &[ContractId("BP-SPROUTING-1")], claim: VerificationClaimKind::Conformance, verification: PLAN_STRUCTURAL } },
    ProofRowRecord { id: ProofRowId("search_and_holdout_sets_are_disjoint"), state: ProofRowState::Active { guarantee: GuaranteeRef::dec("DEC-081"), projection_contracts: &[ContractId("BP-SPROUTING-1")], claim: VerificationClaimKind::Conformance, verification: PLAN_STRUCTURAL } },
    ProofRowRecord { id: ProofRowId("failed_holdout_candidate_is_quarantined"), state: ProofRowState::Active { guarantee: GuaranteeRef::dec("DEC-081"), projection_contracts: &[ContractId("BP-SPROUTING-1")], claim: VerificationClaimKind::Refinement, verification: PLAN_HOLDOUT_QUARANTINE } },
