...
//! names, and workspace paths stay in `spec/architecture/types.rs` and
//! `spec/architecture/inventory.rs`; toolchain channel, version floor,
//! edition, resolver, and the tracked `rust-toolchain.toml` bytes stay in
//! `spec/toolchain/types.rs`. Completeness of
