...
pub use contract::admission::{
    ...
    compile_profile_drift_membrane, compile_support_membrane, compose_membranes, decode_validated,
    evaluate, validate, verify_certificate, AdmissionProgram, CertNode, CircuitBuilder, CompareRel,
    Decision, EvalError, InputDecl, InputSlot, Lane, LimitViolation, LookupTable, Node, NodeId,
    NodeOp, Outputs, ProgramCertificate, ProgramError, ProgramLimits, ValidationError, Width,
