...
## Decision
batpak adds `Store::project_run_evidence` and `bpk-lib/crates/core/src/store/projection_run.rs`.
...
- `100_ADR_0023_PROJECTION_RUN_EVIDENCE_REPORT_DESIGN.md`
- `080_EVIDENCE_REPORTS.md`
- `bpk-lib/crates/core/src/store/projection_run.rs`
