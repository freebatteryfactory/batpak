...
`bpk-lib/crates/core/src/store/subscriber_frontier.rs` as a minimal structural evidence surface.
...
- `bpk-lib/crates/core/src/store/subscriber_frontier.rs`
- `bpk-lib/crates/core/src/store/write/fanout.rs`
- `bpk-lib/crates/core/src/store/delivery/subscription.rs`
