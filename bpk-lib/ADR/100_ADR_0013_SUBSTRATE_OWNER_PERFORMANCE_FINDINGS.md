...
- targeted native-only benchmark surfaces in `bpk-lib/crates/core/benches/unified_bench.rs` and
  `bpk-lib/crates/core/benches/batch_throughput.rs`
...
Per the repo's own hint ladder in `bpk-lib/tools/integrity/src/main.rs`, this is
...
`bpk-lib/crates/core/benches/projection_latency.rs`, which made reopen/close timing reflect the
...
`bpk-lib/crates/core/src/store/write/writer/runtime.rs`: the writer drains already-queued ordinary
...
- SIDX boundary discovery in `bpk-lib/crates/core/src/store/segment/mod.rs` is anchored to physical
...
- Environment hint ladder: `bpk-lib/tools/integrity/src/main.rs`
- Writer cadence drain loop: `bpk-lib/crates/core/src/store/write/writer/runtime.rs`
- Single append path: `bpk-lib/crates/core/src/store/write/writer/append.rs`
- Batch sync-before-visible path: `bpk-lib/crates/core/src/store/write/writer/batch.rs`
- Segment frame decode and SIDX boundary discovery: `bpk-lib/crates/core/src/store/segment/mod.rs`
- Segment scan behavior: `bpk-lib/crates/core/src/store/segment/scan/full_scan.rs`
- New batching/cadence benchmark surfaces:
  - `bpk-lib/crates/core/benches/unified_bench.rs`
  - `bpk-lib/crates/core/benches/batch_throughput.rs`
- Technical reference tuning surface: `020_TECHNICAL_REFERENCE.md`
