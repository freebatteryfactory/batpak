...
surface is a private `bpk-lib/crates/core/tests/chaos/` module with a `dm_flakey` wrapper that:
...
## References
- [ADR-0014: Durable Frontier Observability](100_ADR_0014_DURABLE_FRONTIER.md)
- `bpk-lib/traceability/invariants.yaml`: `INV-FRONTIER-FAULT-ORDINALS`,
