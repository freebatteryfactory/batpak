...
# ---------------------------------------------------------------------------
# Hostiles: every refusal above is proven live, and the independent verifier
# is proven two-sided (a tampered bundle is refused; a blinded verifier goes
# silent, which the battery catches).
# ---------------------------------------------------------------------------

def _hostiles(paths: dict, work: Path) -> list[str]:
    findings: list[str] = []
