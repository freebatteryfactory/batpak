# Process boundary / supervisor evidence (Moonwalker Host)

**Owner layer:** above batpak (Moonwalker Host support spec).
...
- Must not require new store primitives unless batpak grows a generic,
  domain-neutral process runner (out of scope for the pre-Moonwalker arc).
