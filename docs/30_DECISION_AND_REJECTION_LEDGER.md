...
| DEC-030 | LOCK | Availability axes | Value state, truth, decision, completeness, freshness, proof are separate; numeric sorts exact approximate and interval are orthogonal to these axes per DEC-069 and docs/37 |
...
| DEC-034 | KEEP | One evaluation, many projections | Value/explanation/evidence/margin/cost share typed evaluation; numeric evaluation projects value margin evidence and explanation per DEC-069 and docs/37 |
