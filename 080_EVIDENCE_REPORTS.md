...
- `SchemaSnapshotEvidenceReport` (`bpk-lib/crates/core/src/schema.rs`)
- `ChainWalkEvidenceReport` (`bpk-lib/crates/core/src/store/chain_walk.rs`)
- `SubscriberFrontierEvidenceReport` (`bpk-lib/crates/core/src/store/subscriber_frontier.rs`)
...
- **Store resource selected config facets:** `StoreResourceEvidenceReport`
  ...
  platform evidence summary (see `bpk-lib/crates/core/src/store/store_resource_report.rs`).
...
- Additional registry attestation flows beyond the registry row envelope already
  in `bpk-lib/crates/core/src/registry.rs`.
