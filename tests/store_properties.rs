...
fn error_kind_is_domain() {
    let not_found_is_domain = ErrorKind::NotFound.is_domain();
    ...
    let custom_is_domain = ErrorKind::Custom(99).is_domain();
