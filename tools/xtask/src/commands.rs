...
use crate::{
    BenchSurface, ChaosArgs, FuzzArgs, MutantMode, MutantSurface, MutantsArgs, PlatformArgs,
    PlatformCommand, ReleaseArgs, SetupArgs,
};
...
const PLATFORM_BACKEND_MUTANT_FILES: &[&str] = &[
...
mod tests {
    use super::{
        ...
        next_ratchet_floor, read_platform_profile, setup, surface_excludes, MutantExecutionPlan,
        MutationBaseline, MutationLane, MutationScope, MutationScore, MutationSharding,
        RepoMutationPhase, CURSOR_MUTANT_FILES, EVENT_PAYLOAD_REGISTRY_MUTANT_FILES,
        ...
        PLATFORM_BACKEND_MUTANT_FILES, PROJECTION_MUTANT_FILES, REPO_MUTATION_PHASE,
        REPO_WIDE_ALL_FEATURES_MUTANT_FILES, REPO_WIDE_NO_DEFAULT_MUTANT_FILES,
        SIDX_EMPTY_FOOTER_FLOOR_EQUIVALENT_MUTANT, WRITER_COMMIT_MUTANT_FILES,
    };
